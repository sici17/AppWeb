...
public class RisorsaController {
    ...
    public ResponseEntity<String> handleRisorsaNotFoundException(RisorsaNotFoundException ex) {
        return ResponseEntity.status(HttpStatus.NOT_FOUND).body("Risorsa non trovata");
    }
