...
public class TesseraLibreria {
    ...
    public enum StatoTessera {
        RICHIESTA_PENDING("Richiesta in attesa"),        // 🆕 NUOVO
        RICHIESTA_APPROVATA("Richiesta approvata"),      // 🆕 NUOVO  
        RICHIESTA_RIFIUTATA("Richiesta rifiutata"),      // 🆕 NUOVO
        ATTIVA("Attiva"),
        SCADUTA("Scaduta"),
        SOSPESA("Sospesa"),
        REVOCATA("Revocata"),
    ...
    @Basic
    @Column(name = "admin_approvatore_id")
    private Integer adminApprovatoreId;

    @Basic
    @Column(name = "note_richiesta", columnDefinition = "TEXT")
